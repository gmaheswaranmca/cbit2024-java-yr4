...
4: 2,3,5
5: 1,4
visited: 1 2 3 4 5|  call_stack:v1[1 :: [2|,3,5]],v2[2 :: [1,3|,4]],
    v3[3 :: [1,4|,5]], v4[4 :: [2,3,5|]], v5[5 ::[1,4]]   | print: 1 2 3 4 5
*/
class GraphOp {
  public static void doDFS(Map<Integer, List<Integer>> graph, int start) {
  ...
  public static void dfs(Map<Integer, List<Integer>> graph, int node, Set<Integer> visited) {
      visited.add(node); //marked 
      System.out.printf("%d ",node); //do visit
